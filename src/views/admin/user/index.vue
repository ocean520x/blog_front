...
<template>
  <main v-if="users" class="">
    ...
    <MyPagination @current-change="$router.push({name:'user.index',params:{u_id:$route.params?.u_id},query:{page:$event}})" :per-page="users.meta.per_page" :total="users.meta.total" />
  </main>
</template>
